...
int main()
{
    ...
    int check(int number[], int size){
        //b1 tao ra mang phu de kt phan tu trung lap
        int sinNumber [1001];
        for(int  i=0;i<size; i++){
            if(sinNumber[number[i]]==1){
                return 1;
            }
        }
        //xet tung phan tu 
        //kt xem phan tu dc xet da dc tim thay chua
        //tim thay tra ve 1
        //neu ko co phan tu nao trung lap thi tra ve 0
